        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><button onClick={() => scrollToSection('o-firmie')} className="hover:text-blue-400 text-left transition-colors cursor-pointer">O firmie</button></li>
              <li><button onClick={() => scrollToSection('oferta')} className="hover:text-blue-400 text-left transition-colors cursor-pointer">Oferta</button></li>
              <li><button onClick={() => scrollToSection('projekty')} className="hover:text-blue-400 text-left transition-colors cursor-pointer">Projekty</button></li>
              <li><button onClick={() => scrollToSection('kontakt')} className="hover:text-blue-400 text-left transition-colors cursor-pointer">Kontakt</button></li>
            </ul>
          </div>
