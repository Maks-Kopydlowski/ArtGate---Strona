...
export default {
  async fetch(request, env, ctx) {
    ...
    const corsHeaders = {
      ...
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com; frame-src 'self' https://challenges.cloudflare.com https://www.google.com https://maps.google.com https://*.google.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https://images.unsplash.com https://*.google.com https://*.googleapis.com; connect-src 'self' https://artgate-backend.maks-kopydlowski.workers.dev https://places.googleapis.com https://challenges.cloudflare.com https://api.resend.com;",
    };
